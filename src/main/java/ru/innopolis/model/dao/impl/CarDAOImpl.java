...
import ru.innopolis.model.dao.api.CarDAO;
...
/**
 * Implements the Car DAO interface.
 * Communicates with the relation Car in the database.
 *
 * @author      Ilya Borovik
 * @version     1.0
 * @see         DAO
...
public class CarDAOImpl implements CarDAO {
    static {
        PropertyConfigurator.configure(CarDAOImpl.class.getClassLoader().getResource("log4j.properties"));
    }
