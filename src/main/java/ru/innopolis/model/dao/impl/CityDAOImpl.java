...
import ru.innopolis.model.dao.api.CityDAO;
 ...
 * @author      Ilya Borovik
 * @version     1.0
 * @see         ru.innopolis.model.dao.api.DAO
 * @see         ru.innopolis.model.dao.api.CityDAO
 */
public class CityDAOImpl implements CityDAO {
    static {
        PropertyConfigurator.configure(CityDAOImpl.class.getClassLoader().getResource("log4j.properties"));
    }
