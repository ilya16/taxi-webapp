...
import ru.innopolis.model.dao.api.RideDAO;
...
/**
 * Implements the Ride DAO interface.
 * Communicates with the relation Ride in the database.
 *
 * @author      Ilya Borovik
 * @version     1.0
 * @see         DAO
...
public class RideDAOImpl implements RideDAO {
    static {
        PropertyConfigurator.configure(RideDAOImpl.class.getClassLoader().getResource("log4j.properties"));
    }

    private static final Logger LOGGER = LogManager.getLogger(RideDAOImpl.class);
